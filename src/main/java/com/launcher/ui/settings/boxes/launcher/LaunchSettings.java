...
public class LaunchSettings extends TextFieldElement {
    ...
    protected void fillBox(){
        ...
        this.content.add(this.getButtonLine(TranslationManager.format("btn.get_files"), "File", "logos/folder.png", "#ffeb7e"), 0, 3);
        this.content.add(this.getButtonLine(TranslationManager.format("btn.uninstall"), "Uninstall", "logos/delete.png", "#8b2628"), 0, 4);
    }
}
