package com.launcher.utils.minecraft.json;
...
import com.launcher.utils.assets.AssetIndexInfo;
import com.launcher.utils.minecraft.java.JavaVersion;
...
public class MinecraftVersion {
	...
	public MinecraftVersion(MinecraftVersion version) {
		...
		if (version.arguments != null) {
			this.arguments = new HashMap<ArgumentType, List<Argument>>();
			for (Map.Entry<ArgumentType, List<Argument>> entry : version.arguments.entrySet()) this.arguments.put(entry.getKey(), new ArrayList<Argument>(entry.getValue()));
		}
